...
export class ProductService {
  ...
  categories = [
    { name: 'Smartphones', slug: 'smartphones', icon: '📱', color: '#8b5cf6', image: 'https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Laptops', slug: 'laptops', icon: '💻', color: '#3b82f6', image: 'https://images.pexels.com/photos/18105/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Mode Femme', slug: 'womens-dresses', icon: '👗', color: '#ec4899', image: 'https://images.pexels.com/photos/336372/pexels-photo-336372.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Mode Homme', slug: 'mens-shirts', icon: '👔', color: '#1e40af', image: 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Beauté', slug: 'fragrances', icon: '💄', color: '#f43f5e', image: 'https://images.pexels.com/photos/965989/pexels-photo-965989.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Maison', slug: 'home-decoration', icon: '🏠', color: '#10b981', image: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Sport', slug: 'sports-accessories', icon: '⚽', color: '#f97316', image: 'https://images.pexels.com/photos/1432039/pexels-photo-1432039.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' },
    { name: 'Bijoux', slug: 'womens-jewellery', icon: '💎', color: '#a855f7', image: 'https://images.pexels.com/photos/265906/pexels-photo-265906.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&dpr=1' }
  ];
